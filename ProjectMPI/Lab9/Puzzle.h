...
public:
	...
	*/
	...
	/*
	Function which transform the puzzle in a way to be sent over the network
	@return vector<int> - the matrix of the puzzle rolled over in a vector
	*/
	...
	/*
	Constructor for the Puzzle class which uses from the data received over the network
	@param vector<int> puzz - the vector which contains the order of the values in the puzzle
	@param int fI - the line index of the free space
	@param int fJ - the column index of the free space
	@param int moves - the number of moves for reaching this configuration of the puzzle
	*/
